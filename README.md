...
4. **Reasoning Engine (RAG):** Live numerical traffic metrics are serialized into structured prompts for Gemma 3.0 to generate actionable signal timing modifications.
...
**APIs & AI**
* Google Gemma 3.0 (Core LLM reasoning engine)
...
│   │   ├── rag/              # Gemma 3.0 Flash prompts and integration
